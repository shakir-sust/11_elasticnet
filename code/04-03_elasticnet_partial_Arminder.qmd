...
#install.packages("glmnet") implement elastic
#install.packages("vip")
#install.packages("tidymodels") run machine models
...
final_fit %>%
  collect_predictions()
```
Why 212 observations?  bcse it the test set
...
rmse is larger on test set than train set
